...
\newcommand{\myparagraph}[1]{\vspace{0.5mm} \textbf{#1}.}
...
\input{body/myChapter01.tex}

% 第2章
% \input{body/chapter02}
\input{body/myChapter02.tex}

% 第3章
% \input{body/chapter03}
\input{body/myChapter03.tex}

% 第4章
% \input{body/chapter04}
\input{body/myChapter04.tex}
